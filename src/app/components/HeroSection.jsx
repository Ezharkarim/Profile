      ...
      <div className="grid grid-cols-1 lg:grid-cols-12">
        ...
        >
          ...
          <div>
            ...
            <button className=" px-1 py-1 w-full sm:w-fit  bg-gradient-to-br from-blue-500 via-purple-500 rounded-full bg-transparent hover:bg-slate-800 text-white mt-3">
